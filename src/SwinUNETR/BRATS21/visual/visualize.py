...
img_add = os.path.join(data_dir, "ceT1/crossmoda2021_ldn_100_ceT1.nii.gz")
label_add = os.path.join(data_dir, "ceT1/crossmoda2021_ldn_100_Label.nii.gz")
