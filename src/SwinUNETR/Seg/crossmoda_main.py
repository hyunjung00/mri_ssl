...
from crossmoda_trainer import run_training
...
parser.add_argument(
    "--data_dir", default="../../../data/crossmoda/", type=str, help="dataset directory"
)
parser.add_argument(
    "--json_list",
...
parser.add_argument(
    "--world_size", default=5, type=int, help="number of nodes for distributed training"
)
parser.add_argument(
...
def main_worker(gpu, args):
    ...
    if (
        args.pretrained_dir
        == "../Pretrain/runs/crossmoda_pretrain/"
    ):
        ...
        print("Using Crossmoda CeT1 and hrT2 pretrained SSL Swin UNETR backbone weights!")
